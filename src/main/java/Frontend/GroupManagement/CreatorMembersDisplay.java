 ...
 * @author carls
 */
public class CreatorMembersDisplay extends javax.swing.JPanel {
    ...
    String userId;
    String gpId ;
    public CreatorMembersDisplay(Manager a, String name, String photo ,String userId, String gpId) {
        initComponents();
        this.a = a;
        this.photo = photo;
        this.name = name;
